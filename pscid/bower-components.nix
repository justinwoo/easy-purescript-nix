...
buildEnv { name = "bower-env"; ignoreCollisions = true; paths = [
  ...
  (fetchbower "purescript-psc-ide" "15.0.1" "^15.0.0" "1k0924b9dsw89vv2rr0smbhs6m64qxz342w7zk3dz2wkhxz4ild9")
  (fetchbower "purescript-psa-utils" "6.0.0" "^6.0.0" "05g3wwdn3x6zvhw6pmvz8824d8qh27lkdvpd5zy2sl2n6l7lllcd")
  (fetchbower "purescript-optparse" "3.0.1" "^3.0.1" "0ppcd95q1nr11jpbkjbyh9hi2sg3y94a345jzd000fkyq43ngaw2")
  (fetchbower "purescript-node-streams" "4.0.0" "^4.0.0" "0ni51slpi9jszpp3xdqrw85d3aj2p367na5qq6icc8brd5hw26wv")
  (fetchbower "purescript-node-process" "7.0.0" "^7.0.0" "0s68sl4xks0a7z4fmb8843lc4xwb36vic8hixr3k5qhb3rcvbim1")
  (fetchbower "purescript-suggest" "5.0.0" "^5.0.0" "10mrk6bwrv61lmf2dm14sfzid33h0hckf86jj48pydylz5f81r12")
  (fetchbower "purescript-arrays" "5.3.0" "^5.3.0" "1h7dwnw42aw5fk84rm34xhcldxqlvik7r0pi64rqyr3m3iz0h9mq")
  ...
  (fetchbower "purescript-argonaut" "6.0.0" "^6.0.0" "175z2vxslz3aqamiri82hbcb3f9r9g1h57bh3dpiw8ggvsk051dr")
  ...
  (fetchbower "purescript-node-child-process" "6.0.0" "^6.0.0" "1c7402cbysshdhfnad6pcpqid219hqwzcazzx2lmbmh6777yi4nv")
  ...
  (fetchbower "purescript-argonaut-core" "5.0.0" "^5.0.0" "1fdxs0w7yzk976vs91cr89syys2vhpwxvpv1kfiamlin5akw42d0")
  (fetchbower "purescript-argonaut-codecs" "6.0.2" "^6.0.2" "1jcmgz3j7dv06jxrnwq704abpaqi9jcipaizzmhgiphhzpfpx5rr")
  ...
  (fetchbower "purescript-exitcodes" "4.0.0" "^4.0.0" "178lf7h1vngdircp6hg540vamjy8j9a1k4y7w7gw8kza0sqs567v")
  (fetchbower "purescript-memoize" "5.0.0" "^5.0.0" "1hgjsc0n7z95l6g1p1kddjsdlwridlyi7zxvx4hpvbd088k2i5dr")
  (fetchbower "purescript-exists" "4.0.0" "^4.0.0" "0am106isq17p8zi4j2snakb7548rz16ian9cs5wyjy5rsk204pbz")
  (fetchbower "purescript-free" "5.2.0" "^5.1.0" "00l041n9la0v39sn0w4d89dhkafz5rzjmhhsiwnaflaaqh3f7rmv")
  (fetchbower "purescript-node-buffer" "5.0.0" "^5.0.0" "1qrwhpbsa5y9kgk5aqwg1bs7xww5395xwqiam8dp8b5c9iypkdd8")
  (fetchbower "purescript-foreign-object" "2.0.3" "^2.0.1" "0b55xnhyhvwjmsk1dbbnigm8d9lkxa4mva1shch1hag629xs4ral")
  ...
  (fetchbower "purescript-argonaut-traversals" "7.0.0" "^7.0.0" "1pfk008ia5q1mcm6vk3a00m50ygcmip6700cy9zifz229zc9vlbv")
  ...
  (fetchbower "purescript-record" "2.0.1" "^2.0.0" "1l590fg9724zirvl165wasi1ym3hy33x4dwdsbcdc5r97d97y8fb")
  ...
  (fetchbower "purescript-typelevel-prelude" "5.0.0" ">= 4.0.0 < 6.0.0" "04by7nd8lwrikbpnax042sgdci5gf3sa87nyg9v9hl80xb0s3f5k")
  (fetchbower "purescript-profunctor-lenses" "6.2.0" "^6.0.0" "15ba862g336nzdf7bmg7s1rdxxrnfwbbc6k3wczgjfyivvj1zsaw")
